...
- **Phase 2b — agent integration (next):** wire retrieval into the live voice agent (search-as-a-tool mid-call), grounding/escalation policy when confidence is low, evidence display in the replay view, retrieval-specific eval cases.
